...
export default function PortfolioBanner() {
  ...
  return (
    <section className="relative w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-10 sm:py-14 md:py-20 lg:py-24 xl:py-32">
      <div className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] lg:h-[90vh] overflow-hidden rounded-[25px]">
        {/* Background Video */}
        ...
        >
          <source src="/images/logo/10678920-uhd_4096_2160_25fps.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative z-10 h-full flex flex-col justify-between px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 md:py-16 lg:py-20">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/90 leading-relaxed whitespace-pre-line">
              {t('description')}
            </p>
          </motion.div>
